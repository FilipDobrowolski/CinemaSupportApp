namespace CinemaSupport.Data.Migrations
{
    ...
    public partial class AuthorizationModel : DbMigration
    {
        public override void Up()
        {
            RenameTable(name: "dbo.Actors", newName: "AspNetUsers");
        ...
        public override void Down()
        {
            ...
            AddPrimaryKey("dbo.AspNetUsers", "ID");
            CreateIndex("dbo.Workers", "ID");
            CreateIndex("dbo.Clients", "ID");
            CreateIndex("dbo.Tickets", "ClientID");
            AddForeignKey("dbo.Workers", "ID", "dbo.Actors", "ID");
            AddForeignKey("dbo.Clients", "ID", "dbo.Actors", "ID");
            AddForeignKey("dbo.Tickets", "ClientID", "dbo.Clients", "ID");
            RenameTable(name: "dbo.AspNetUsers", newName: "Actors");
        }
    }
}
